...
##  ----------------------------------------  ##
##     K80 models RAxML on the Cluster        ##
##  ----------------------------------------  ##

# first get newest version of raxml on the cluster
# then run 4 runs: full, nonasc, lewis, stam
...
# open(OUT, ">job.sh") or die;
  ...
  # print OUT "#PBS -d /gscratch/leache/Barb/k80_raxml/full/\n";
  # print OUT "/gscratch/leache/Barb/standard-RAxML-master/raxmlHPC-PTHREADS-SSE3 -T 16 -s ".$whichFile." -f a -m GTRCAT -V --K80 -x ".$seed1." -# autoMRE -p ".$seed2." -o GAWI1 -n full_out_".$whichFile."\n";
# close(OUT);
...
# open(OUT, ">job.sh") or die;
 ...
 # print OUT "#PBS -l nodes=1:ppn=16,feature=16core,mem=22gb,walltime=500:00:00\n";
 # print OUT "#PBS -o /gscratch/leache/Barb/jobLogs/\n";
 # print OUT "#PBS -d /gscratch/leache/Barb/k80_raxml/nonasc/\n";
 # print OUT "/gscratch/leache/Barb/standard-RAxML-master/raxmlHPC-PTHREADS-SSE3 -T 16 -s ".$whichFile." -f a -m GTRCAT -V --K80 -x ".$seed1." -# autoMRE -p ".$seed2." -o GAWI1 -n nonasc_out_".$whichFile."\n";
# close(OUT);
...
# open(OUT, ">job.sh") or die;
 ...
 # print OUT "#PBS -l nodes=1:ppn=12,feature=12core,mem=22gb,walltime=500:00:00\n";
 # print OUT "#PBS -o /gscratch/leache/Barb/jobLogs/\n";
 # print OUT "#PBS -d /gscratch/leache/Barb/k80_raxml/vlewis/\n";
 # print OUT "/gscratch/leache/Barb/standard-RAxML-master/raxmlHPC-PTHREADS-SSE3 -T 16 -s ".$whichFile." -f a -m ASC_GTRCAT -V --K80 --asc-corr=lewis -x ".$seed1." -# autoMRE -p ".$seed2." -o GAWI1 -n lewis_out_".$whichFile."\n";
# close(OUT);
...
# open(OUT, ">job.sh") or die;
 ...
 # print OUT "#PBS -l nodes=1:ppn=12,feature=12core,mem=22gb,walltime=500:00:00\n";
 # print OUT "#PBS -o /gscratch/leache/Barb/jobLogs/\n";
 # print OUT "#PBS -d /gscratch/leache/Barb/k80_raxml/vstam/\n";
 # print OUT "/gscratch/leache/Barb/standard-RAxML-master/raxmlHPC-PTHREADS-SSE3 -T 16 -s ".$whichFile." -f a -m ASC_GTRCAT -V --K80 --asc-corr=stamatakis -q ".$whichFile.".part -x ".$seed1." -# autoMRE -p ".$seed2." -o GAWI1 -n stam_out_".$whichFile."\n";
# close(OUT);
